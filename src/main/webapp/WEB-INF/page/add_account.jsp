    ...
    <div class="middle">
        <div class="left">
            <ul style="transform: translate(0,10%)">
                <li class="line"><a href="/account/${user.id}/${account.wname}/page/1">账号</a></li><hr>
                <li class="line"><a href="">个人中心</a></li><hr>
            </ul>
        </div>
        <div class="right">
            <div class="add_top">添加账号</div>
            <form class="layui-form" action="/accountAdd/${user.id}/${account.wname}" method="post">
